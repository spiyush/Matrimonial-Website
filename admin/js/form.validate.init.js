...
//        live: 'disabled',
    ...
    $('#AjaxSubmit')
        .bootstrapValidator({
            ...
            fields: {
                AONumber: {
                    message: 'The AONumber is not valid',
                    validators: {
                        notEmpty: {
                            message: 'The AONumber is required and can\'t be empty'
                        },
                        stringLength: {
                            min: 6,
                            max: 30,
...
//        trigger: 'blur',
    ...
    $('#formvalidation').bootstrapValidator({
        ...
        fields: {
            ...
            OIC: {
                message: 'The OIC is not valid',
                validators: {
                    notEmpty: {
                        message: 'The OIC is required and can\'t be empty'
                    },
                    stringLength: {
                        min: 6,
                        max: 30,
                        message: 'The OIC must be more than 6 and less than 30 characters long'
                    },
                    regexp: {
                        regexp: /^[a-zA-Z0-9_\.]+$/,
                        message: 'The OIC can only consist of alphabetical, number, dot and underscore'
                    }
                }
			},
