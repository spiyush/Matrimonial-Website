...
<div class="modal-dialog modal-sm" style="width:55%" >
 ...
 <div class="container" >
      <header class="header clearfix">
        ...
        <h3  class="text-muted">location search</h3>
      </header>
...
<div class="col-md-7 col-sm-12 col-xs-12" style="padding-left:40px;">
 ...
 <div class="input-group">
       ...
       <input type="radio" value="female" id="female" name="trip"><font size="4">    Female</label></font>
              ...
              <input type="text" class="form-control"name=" country" placeholder="name of country" required>
           </div>

                  <div class="form-group has-success">
              <input type="text" class="form-control"state" placeholder="name of state" required>
           </div>
           <div class="form-group has-success">
