...
<div class="col-md-9 col-sm-12 col-xs-12" style="padding-left:40px;">                      
...
<form action="forgetconpassv.php" method="POST" class="form-horizontal" role="form">
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Email:</label>
    <div class="col-md-9">
      
      <input type="email"  name="emailfp" class="form-control input-lg" id="emailfp" autofocus onkeyup="showHint1(this.value)" placeholder="Enter email">
    ...
    <div class="col-sm-offset-2 col-sm-8">
      <a href="confirmpass.php"type="submit" class="btn btn-primary">Submit</a>
