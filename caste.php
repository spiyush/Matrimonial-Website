...
<div class="modal-dialog modal-sm" style="width:55%" >
 ...
 <div class="container" >
      <header class="header clearfix">
        ...
        <h3  class="text-muted">Caste search</h3>
      </header>
...
<div class="col-md-7 col-sm-12 col-xs-12" style="padding-left:40px;">
        ...
        <div class="col-md-6">   
              <form role="form" action="cardetail.php" method="post" enctype="multipart/form-data">
      ...
      <td style="padding-left:100px;">
               <div class="form-group col-md-4" style="width:150%">
      <label for="inputState"><font size="4">Categery</font></label>
      <select id="inputState" class="form-control">
        ...
        <option>NT</option>
         <option>SBC</option>
              ...
              <input type="text" class="form-control"Caste" placeholder="caste" required>
           </div>
           <div class="form-group has-success">
              <input type="text" class="form-control"name="SubCaste" placeholder="SubCaste" required>
           </div>
      ...
      <tr>
       <td>
           ...
           <input type="text" class="form-control" name="Age"  placeholder="From Age" >
         </div>
            </div></td> 
            <td style="padding-left:100px;">
            <div class="form-group" style="width:140%">
               ...
               <input type="text" class="form-control" name="Weight"  placeholder="To Age">
         </div>
            </div>
       </td>
  ...
  <div class="form-group clearfix">
            <label class="col-sm-4 controlLabel">Profiles </label>
            <div class="col-lg-8 col-md-8">
      <div class="checkbox checkbox-inline">
               <input name="photo" type="checkbox" id="photo" value="photo">
                <label for="photo">with Photo</label>
              </div><br><br>
               
               <a href="userprofile.php"type="submit" class="btn btn-primary">Search</a>
